// gonna install express  (npm i express)
// try lang
...
app.engine("html", require("ejs").renderFile); // nag install pa ng ejs (npm install ejs)
...
function main(
  ...
  //    const streamingLimit = 10000; // ms - set to low number for demo purposes
    ...
    var holder = ''; // holder nung paglalagyan ng text
      ...
      if (stream.results[0].isFinal) {
        ...
        app.get('/', (req, res) => {
          var loc = path.join(__dirname, '../' + '/front-end/views/index.html')
            ...
            // res.render(__dirname, '../' + '/front-end/index.html', {holder:holder});
  ...
  // try
  // for node js lang daw sya
      module.exports = {
        // holder: this.holder,
        speechCallback(){}
        // speechCallback: speechCallback
      };
      exports.holder = this.holder;